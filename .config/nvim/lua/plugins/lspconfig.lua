...
return {
    ...
    config = function()
        ...
        -- vim.lsp.config('ts_ls', { NOTE still needs to be enabled manually, better to add to table and enable both
        --
        -- })

        -- define servers to be enabled + config overwrite
        local servers = {
            lua_ls = {
            ...
            eslint_lsp = { capabilities = capabilities },
